...
const Folder = () => {
  ...
  return (
    <svg {...events} width="200" height="200" viewBox="0 0 86 80" fill="none">
      <rect width="45" height="49" rx="8" transform="matrix(1 0 0.0660997 0.997813 11.2793 19)" fill="#3B83FE" />
      <motion.g
      ...
      <defs>
        ...
        >
          ...
          <feColorMatrix type="matrix" values="0 0 0 0 0.596078 0 0 0 0 0.639216 0 0 0 0 0.717647 0 0 0 0.24 0" />
