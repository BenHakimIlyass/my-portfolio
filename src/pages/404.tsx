  ...
  return (
    <>
      ...
      <MainPlayground space={3}>
        <Box position="absolute" top="-60vh" width="100%">
          <svg width="100%" height="100%" viewBox="0 0 1152 684" fill="none" xmlns="http://www.w3.org/2000/svg">
            <motion.path
        ...
        <Container>
          ...
          <Text clone="h4" textAlign="center">
            <Link href="/">
              <a ref={ref} style={{ fontWeight: 700 }}>
                I got the home page
              </a>
            </Link>
          </Text>
...
// Change the y value in MainPlayground 920 breakpoint by md
