                  ...
                  {!downLg && (
                    <Box width={{ xs: "100%", lg: "40%" }} mb={{ md: 50 }} mt={{ md: "auto" }}>
                      <P direction="right">
                        ...
                        using it to animate svg elements sometimes. So here I created these tiny cute icons and I tried
                        to animate them with framer-motion.
                      </P>
                    </Box>
                  )}
...
const WrappGif = ({ color, ...props }) => {
  ...
  return (
    <Gif width={{ xs: "100%", lg: "40%" }} ref={ref}>
      ...
      <Center>
        <motion.div
          animate={{ scale: isOnScreen ? 1 : 1.2, filter: isOnScreen ? "blur(0px)" : "blur(2px)" }}
